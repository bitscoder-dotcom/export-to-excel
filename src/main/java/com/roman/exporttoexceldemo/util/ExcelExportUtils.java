package com.roman.exporttoexceldemo.util;
...
// This method is to create the cells
...
// This method is to create the workbook header
    private void createHeaderRow() {
        ...
        createCell(row, 7, "Street Address", style);
    }

// Create a method to get the customer data to fit into the different columns
...
// next is to iterate through the info gotten from customerDb
        for (Customer customer : customerList) {
            ...
            createCell(row, columnCount++, customer.getAddress().getStreetAddress(), style);
        }
    }

// next method will be called in the controller to export customer records from the db
